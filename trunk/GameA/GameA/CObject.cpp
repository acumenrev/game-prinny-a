...
CCObject::CCObject(float fX, float fY, char style)
{
	...
	case UNIT_MONSTER2:
		...
		m_canBeDestroyed = true;
		m_rect = _Rectangle(fX, fY, 40, 40);
		m_workingArea = _Rectangle(fX-SizeTile*12, fY-SizeTile*10, SizeTile*20, SizeTile*20);
		m_vX = 2;
		m_vY = 0;
		break;
	case UNIT_MONSTER3:
		...
		m_canBeDestroyed = true;
		m_rect = _Rectangle(fX, fY, 40, 40);
		m_workingArea = _Rectangle(fX-SizeTile*4, fY-SizeTile*4, SizeTile*8, SizeTile*8);
		m_vX = 2;
		m_vY = 0;
		break;
	case UNIT_FIRE1:
